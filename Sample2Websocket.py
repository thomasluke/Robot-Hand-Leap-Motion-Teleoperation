...
class SampleListener(Leap.Listener):
    ...
    def on_frame(self, controller):
        ...
        normal = resultj['hands'][0]['palmNormal'] # Normal vectors points outwards from palm
        direction = resultj['hands'][0]['direction'] # Direction vector points from palm towards fingertips
        ...
        for finger in resultj['pointables']:
            ...
            hand_vector = numpy.array([direction[0],direction[1],direction[2]])
            hand_normal_vector = numpy.array([normal[0],normal[1],normal[2]])
            # print numpy.linalg.norm(finger_vector)
